...
def high(message: Message):
    ...
    logger.info(f"Получена команда '/high' от пользователя {message.from_user.id}")
...
def get_max_genre(message: Message):
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            if "docs" in data and data["docs"]:
                films = data["docs"]
                reply = f'Фильмы с макимальным рейтингом в жанре {genre}:\n'
                for film in films:
